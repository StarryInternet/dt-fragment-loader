...
//XXX(nitepone) this is, nasty. planning to possibly remove our deps on
//              of_private in this repo.
#include "kernel_5_4/drivers/of/of_private.h"

//XXX(nitepone) leaving this here to minimize changes from upstream in initial
//              commit.. but we will be removing this.
					  ...
					  const char *new_name)
{
    ...
    // XXX(nitepone) following field was removed between 4.19 to 5.4.
